...
namespace ExperimentOneToManyEntities.APIs
{
    ...
    public class CompaniesController : Controller
    {
        ...
        //Constructor. (In this case, the public CompaniesController() constructor has been created
        //so that the Database property is instantiated as an ApplicationDbContext instance.
        public ApplicationDbContext Database { get; }

        public CompaniesController()
        {
            //The Database property is activated inside the Constructor.
...
public IActionResult Put(int id, [FromBody]string value)
{
	...
	var foundOneCompany = Database.Companies
            ...
            //Send the HttpOkObjectResult class object back to the client.
            return httpOkResult;
        }//End of Put() Web API method      (// PUT api/values/5)
    ...
    }//End of Companies Web API class definition

}//End of ExperimentOneToManyEntities.APIs name space
