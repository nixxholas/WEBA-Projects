...
namespace ExperimentOneToManyEntities.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20160409140249_setupdb")]
    partial class setupdb
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ExperimentOneToManyEntities.Models.Company", b =>
                {
            ...
            modelBuilder.Entity("ExperimentOneToManyEntities.Models.CompanyType", b =>
                {
                    b.Property<int>("CompanyTypeId")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ExperimentOneToManyEntities.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("ExperimentOneToManyEntities.Models.Student", b =>
                {
            ...
            modelBuilder.Entity("ExperimentOneToManyEntities.Models.Company", b =>
                {
                    b.HasOne("ExperimentOneToManyEntities.Models.CompanyType")
                        .WithMany()
            ...
            modelBuilder.Entity("ExperimentOneToManyEntities.Models.Student", b =>
                {
                    b.HasOne("ExperimentOneToManyEntities.Models.Course")
                        .WithMany()
