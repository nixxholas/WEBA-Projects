...
namespace ExperimentOneToManyEntities.APIs
{
    ...
    public class CoursesController : Controller
    {
        ...
        //Constructor. (In this case, the public CoursesController() constructor has been created
       ...
       [HttpGet("GetCoursesForControls")]
        public JsonResult GetCoursesForControls()
        {
			         ...
			         List<object> courseList = new List<object>();
												...
												//Note that, I used three commands to create anonymous objects and add it
												//into the courseList List container.
												//exercise 3.
				        courseList.Add(new
                 {
                    CourseId = 1000,
                    CourseAbbreviation = "DOTA"
                 });
				        courseList.Add(new
                 {
                    CourseId = 2000,
                    CourseAbbreviation = "XBOX"
                 });
				        courseList.Add(new
                 {
                    CourseId = 3000,
                    CourseAbbreviation = "XYZ"
                 });
